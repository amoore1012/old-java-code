//Updated code to descend
//Written by Audrey Moore due Feb 17, 2017
  ...
  public static void printArray(int[] b)
  {
     ...
     public static void selectionSort (int[] numbers)
   {
      ...
      for (int index = 0; index < numbers.length-1; index++)
      {
         ...
         for (int scan = index+1; scan < numbers.length; scan++)
           //I changed the less than sign to greater than to get it in descending order -AUDREY
   ...
   public static void insertionSort (int[] numbers)
   {
      for (int index = 1; index < numbers.length; index++)
      {
         ...
         //now it shifts the smaller values to the right - AUDREY
     ...
     boolean stillLooking;
      ...
      for (int index = 1; index < numbers.length; index++)
      {
        ...
        stillLooking = true;
         ...
         {
           //changed this from less than to greater than to look for the max -AUDREY
